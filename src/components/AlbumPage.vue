                        ...
                        <v-form ref="form">
                            ...
                            <v-text-field outlined color="black" class="textfield mt-3"  v-model="form.artist" label="Artist Name" required :rules="inputRules"></v-text-field>
                                ...
                                <template v-slot:activator="{ on, attrs }">
                                    <v-text-field v-bind="attrs" v-on="on" readonly outlined color="black" v-model="form.date" label="Release Date" required :rules="inputRules"></v-text-field>
                                </template>
                            ...
                            <v-select outlined color="black" :items="[`HYBE`, `SM`, `JYP`,`YG`]" v-model="form.agency" label="Agency" required :rules="inputRules"></v-select>
